...
ZCode 从 v3 开始异军突起，提供了和 Codex 类似的界面和使用体验，除了能接入 GLM 还能接入 DeepSeek，但仍需进一步发展。
...
1. Cursor + Composer 2.5 Thinking (no fast)
   ...
   - 转变心态：如果你更习惯使用编辑器 / IDE 而不是其它 CLI / Desktop APP，Cursor 是你的最优选择，你需要将 Cursor 视为 $20 的顶级模型接入器 + 几乎无限的 Composer 2.5 使用工具
2. Claude Code + 官方订阅 / 中转
   - 速度中等
   - 推荐将 Effort Level 设置为 max，偶尔思考过度
   - 适合做制定计划、架构确定和编码任务等相关工作，几乎不过度设计，完全不防御性编程
   - Opus 4.7、4.8 中文表达很重 AI 味，据说是蒸馏了 GPT5.4 和 Qwen，如果需要中文可以用 Opus 4.6，但建议还是优先 Opus 4.8 1M
3. Codex + 官方订阅 / 中转
   - 速度中等偏下
